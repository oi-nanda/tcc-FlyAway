package com.example.myapplicationflyaway.Components;
...
public class OpenSlidesLayout extends AppCompatActivity {
        ...
        nextbtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if(getItem(0)<3){
                    ...
                    Intent i = new Intent(OpenSlidesLayout.this, LoginActivity.class);
                    startActivity(i);
                    finish();
                }
